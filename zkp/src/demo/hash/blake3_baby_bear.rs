...
pub fn blake3_baby_bear(batch_size: usize) -> Vec<u8> {
    type Val = BabyBear;
    ...
    // experiment using zkp to compress further p3's bad proof serialization.
...
pub fn blake3_baby_bear_zk(batch_size: usize) -> Vec<u8> {
    type Val = BabyBear;
    type Challenge = BinomialExtensionField<Val, 4>;
